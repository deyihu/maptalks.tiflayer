...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('maptalks'), require('geotiff')) :
	typeof define === 'function' && define.amd ? define(['exports', 'maptalks', 'geotiff'], factory) :
	(global = global || self, factory(global.maptalks = global.maptalks || {}, global.maptalks, global.GeoTIFF));
}(this, function (exports, maptalks, geotiff) { 'use strict';
	...
	function getActor() {
	    ...
	    tifActor = new maptalks.worker.Actor(workerKey);
	    return tifActor;
	}
	...
	class TifLayer extends maptalks.TileLayer {
	    ...
	    _getTifTile(tileData) {
	        ...
	        const searchParams = new URL(maptalks.Util.getAbsoluteURL(url)).searchParams;
	    ...
	    _initTif() {
	        ...
	        fetch(url).then(res => res.arrayBuffer()).then(arrayBuffer => {
	            geotiff.fromArrayBuffer(arrayBuffer).then(tiff => {
	                ...
	                const extent = new maptalks.Extent(bounds);
	...
	exports.TifLayer = TifLayer;

	Object.defineProperty(exports, '__esModule', { value: true });

}));
//# sourceMappingURL=maptalks.tiflayer.js.map
